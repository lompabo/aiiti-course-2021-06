---
title: AI in the Industry Tutorials (Health Domain Problems)
...
This tutorial in particular deals with problems arising in the health domain, including predicting arrivals in an Emergency Room center, and combinatorial optimization problems related to the management of scarce resources (i.e. visit rooms and organs for transplants). The lecture introduces two important techniques to make combinatorial optimization solutions practically scalable, i.e. Large Neighborhood Search and Column Generation.
